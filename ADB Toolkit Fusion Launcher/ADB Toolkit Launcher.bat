...
::Not For Put On Size
::It`s For Easlier To Edit
::The Information Start
::Now Version=Ver.None
::End......
:memu
...
echo =[3]按键模拟输入(太多不列举)                                 =
echo =[4]设备信息(型号 电池 分辨率 显示屏 Android版本 IMEI CPU..) =
echo =[5]小功能                                                   =
echo =[6]高级重启和某些关于刷机选项                               =
echo =[7]Shell命令                                                =
echo =[8]打开adb命令行                                            =
...
if '%ERRORLEVEL%'=='4' goto Phone_Information
if '%ERRORLEVEL%'=='5' goto Hided
if '%ERRORLEVEL%'=='6' goto Boot
if '%ERRORLEVEL%'=='7' goto Shell
if '%ERRORLEVEL%'=='8' goto n
if '%ERRORLEVEL%'=='9' goto ABOUT


:n
echo [%date%-%time%]adb.commandline.open>>D:\ADB_Tools.log
start adb.bat
goto memu
...
if '%ERRORLEVEL%'=='4' start Boot\Fastboot.bat
if '%ERRORLEVEL%'=='5' start Boot\Sideload.bat
if '%ERRORLEVEL%'=='6' start Boot\RecoveryInstaller.bat
if '%ERRORLEVEL%'=='7' goto memu
goto Boot
